...
public class MeterSmaSunnyBoy3Impl extends AbstractSunSpecPvInverter implements SunSpecPvInverter, ManagedSymmetricPvInverter,
    ...
    public MeterSmaSunnyBoy3Impl() throws OpenemsException {
        super(//
                ACTIVE_MODELS, //
    ...
    public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
        return new ModbusSlaveTable(//
                ...
                ModbusSlaveNatureTable.of(MeterSmaSunnyBoy3Impl.class, accessMode, 100) //
                        .build());
    }
