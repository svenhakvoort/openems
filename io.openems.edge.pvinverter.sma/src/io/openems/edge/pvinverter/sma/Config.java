...
@ObjectClassDefinition(name = "PV-Inverter SMA", //
		description = "Implements the SMA PV inverter.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "PV-Inverter SMA [{id}]";
